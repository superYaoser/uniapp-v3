<template>
  <view class="w100 h100" style="  overflow: hidden;">
    <view class="w100 h100">
      <view class="userFens__container w100 h100">
        <!--        头部-->
        <view class="userFens__container__header">

          <view style="height: var(--status-bar-height);"></view>
          <view class="userFens__container__header--main">
            <view class="userFens__container__header--button">
              <view @click="pageBack()" style="margin-left: 10px;"><uni-icons type="left" size="20"></uni-icons>
              </view>
            </view>

            <view class="userFens__container__header--title">{{'全部粉丝'}}</view>
            <view class="userFens__container__header--more"></view>
          </view>
        ...
        <!--        身体-->
        <view class="userFens__container__body">
          <view class="w100 h100">
...
import {getUserFensListByUid} from '@/static/api/users'
import {
