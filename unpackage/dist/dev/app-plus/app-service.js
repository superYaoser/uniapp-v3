...
(function(vue, shared) {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-d31e1c47"], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const _sfc_main$8 = {
    ...
    setup() {
      ...
      const useUniEmitCurrentRouterUpdate = (router2) => {
        uni.$emit("currentRouterUpdate", { router: router2 });
        currentR.value = router2;
      };
      const goHome = (router2) => {
        useUniEmitCurrentRouterUpdate(router2);
      };
      const goDynamic = (router2) => {
        useUniEmitCurrentRouterUpdate(router2);
      };
      const goPublish = (router2) => {
        useUniEmitCurrentRouterUpdate(router2);
      };
      const goMessage = (router2) => {
        useUniEmitCurrentRouterUpdate(router2);
      };
      const goMine = () => {
      ...
      vue.createElementVNode("view", { class: "tabbar" }, [
        ...
        vue.createElementVNode("view", null, [
          vue.createVNode(_component_uni_icons, {
            ...
            onClick: _cache[1] || (_cache[1] = ($event) => $setup.goHome("Dynamic"))
          }, null, 8, ["color"]),
        ...
        vue.createElementVNode("view", null, [
          vue.createVNode(_component_uni_icons, {
            ...
            size: "45",
            color: "#13dbf9",
            onClick: _cache[2] || (_cache[2] = ($event) => $setup.goHome("Publish"))
          })
        ]),
        vue.createElementVNode("view", null, [
          vue.createVNode(_component_uni_icons, {
            ...
            onClick: _cache[3] || (_cache[3] = ($event) => $setup.goHome("Message"))
          }, null, 8, ["color"]),
        ...
        vue.createElementVNode("view", null, [
          vue.createVNode(_component_uni_icons, {
            ...
            onClick: _cache[4] || (_cache[4] = ($event) => $setup.goHome("Mine"))
          }, null, 8, ["color"]),
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { id: "Publish" }, " 这是发布页 ");
  }
  const Publish = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/pages/publish/Publish.vue"]]);
  const _sfc_main$4 = {
    components: {},
    data() {
      return {
