    ...
    setup() {
      ...
      const onEditorReady = () => {
        uni.createSelectorQuery().in(this).select(".myEditor").fields({
          ...
          formatAppLog("log", "at pages/publish/Publish.vue:67", res);
      ...
      const pushIt = () => {
        editorCtx.value.getContents({
          success: function(data) {
            formatAppLog("log", "at pages/publish/Publish.vue:117", data);
          },
          fail: function(err) {
            formatAppLog("log", "at pages/publish/Publish.vue:120", err);
          }
        });
      };
      return {
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { id: "Publish" }, [
      ...
      vue.createElementVNode("view", { class: "publish__body" }, [
        vue.createElementVNode("view", null, [
          vue.createElementVNode("view", { class: "editTools" }, [
            vue.createElementVNode("view", {
              class: "item",
              onClick: _cache[2] || (_cache[2] = (...args) => $setup.addTitle && $setup.addTitle(...args))
            }, [
              vue.createElementVNode("text", { class: "iconfont icon-zitibiaoti" })
            ]),
            vue.createElementVNode("view", {
              class: "item",
              onClick: _cache[3] || (_cache[3] = (...args) => $setup.addUnderline && $setup.addUnderline(...args))
            }, [
            ...
            vue.createElementVNode("view", {
              class: "item",
              onClick: _cache[4] || (_cache[4] = (...args) => $setup.addBold && $setup.addBold(...args))
            }, [
              vue.createElementVNode(
                "text",
                {
            ...
            vue.createElementVNode("view", {
              class: "item",
              onClick: _cache[5] || (_cache[5] = (...args) => $setup.addImage && $setup.addImage(...args))
            }, [
          ...
          vue.createElementVNode("view", { class: "content" }, [
            vue.createElementVNode(
              "editor",
              {
                ...
                "show-img-toolbar": "",
                "show-img-resize": "",
                onReady: _cache[6] || (_cache[6] = (...args) => $setup.onEditorReady && $setup.onEditorReady(...args))
              },
              null,
              32
              /* HYDRATE_EVENTS */
