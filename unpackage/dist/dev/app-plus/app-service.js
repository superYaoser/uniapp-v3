...
(function(vue, shared) {
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-d31e1c47"], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const _sfc_main$9 = {
    created() {
      formatAppLog("log", "at pages/loginRegister/loginRegister.vue:34", "App Launch");
      let token = uni.getStorageSync("token");
      formatAppLog("log", "at pages/loginRegister/loginRegister.vue:37", token);
      if (!token) {
        formatAppLog("log", "at pages/loginRegister/loginRegister.vue:39", "没有token"), //跳到登录页面.relaunch可以打开任何界面
        uni.reLaunch({
          url: "/pages/loginRegister/loginRegister"
        });
      } else {
        formatAppLog("log", "at pages/loginRegister/loginRegister.vue:45", "有token");
        uni.reLaunch({
          url: "/pages/MainApp"
        });
      }
    ...
    methods: {
      ...
      Login() {
        loginUseUser({
          ...
          formatAppLog("log", "at pages/loginRegister/loginRegister.vue:98", res);
          if (res.code == 200) {
            try {
              uni.setStorageSync("token", res.token);
            } catch (e) {
              formatAppLog("log", "at pages/loginRegister/loginRegister.vue:103", e);
            }
            uni.redirectTo({
              url: "/pages/MainApp"
            });
  ...
  const PagesLoginRegisterLoginRegister = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-ed6efab4"], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/pages/loginRegister/loginRegister.vue"]]);
  const _sfc_main$8 = {
    name: "TabBar",
    setup() {
  ...
  const TabBar = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-270561e4"], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/components/common/TabBar.vue"]]);
  const _sfc_main$7 = {
    components: {},
    data() {
      return {
  ...
  const Home = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/pages/home/Home.vue"]]);
  const _sfc_main$6 = {
    components: {},
    data() {
      return {
      ...
      vue.createElementVNode("view", { class: "publish" }, [
        vue.createElementVNode("view", { class: "publish__header" }, [
          ...
          vue.createElementVNode("view", { class: "publish__header__button" }, [
            vue.createElementVNode("view", { class: "publish__header__button--publish" }, " 发布 ")
          ])
        ]),
        vue.createCommentVNode("      头部结束")
      ]),
      vue.createElementVNode("view", { class: "publish__body" }, " 这是发布页 ")
    ]);
  }
  ...
  const PagesMainApp = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-dc27c07e"], ["__file", "G:/study/Full Stack developer/Project/uniapp/v3-uniapp/pages/MainApp.vue"]]);
